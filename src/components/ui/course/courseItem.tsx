    ...
    const handleBuyCourse = useCallback(
        async (course: Course) => {
            ...
            try {
                ...
                const price= toWei((course.price).toString(), 'ether');
                await marketPlaceContract.methods.buyCourse(course.index).send({ from: kit.defaultAccount,value: price});
        ...
        [kit.defaultAccount, marketPlaceContract, onGetAllCourses, openNotify],
    );
        ...
        <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
            ...
            <CardContent sx={{ flexGrow: 1 }}>
                ...
                <Stack direction="row" gap={1}>
                    <Typography sx={{ fontWeight: 600 }}>{`${course.price} CELO`}</Typography>
